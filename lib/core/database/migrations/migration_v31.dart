...
///
/// Like [MigrationV28], [MigrationV29] and [MigrationV30] this runs from both
/// paths — `onUpgrade` (`oldVersion < 31`) and `onCreate` (via `MigrationV1`,
...
class MigrationV31 {
  static Future<void> up(Database db) async {
    ...
    // Disabled by default with empty keys: upgrading to v31 must not make a
