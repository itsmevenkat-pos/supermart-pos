# fix_issues.ps1 – fixes missing constructors and billing screen null return
$base = "lib"

$files = @{

    # ---------- FIXED PLACEHOLDER SCREENS ----------
    "features/customers/screens/customer_history_screen.dart" = @'
import 'package:flutter/material.dart';
class CustomerHistoryScreen extends StatelessWidget {
  const CustomerHistoryScreen({super.key});
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Customer History')), body: Center(child: Text('Customer History')));
}
'@
...
class SupplierListScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Suppliers')), body: Center(child: Text('Supplier List')));
}
'@
...
class SupplierFormScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Supplier Form')), body: Center(child: Text('Supplier Form')));
}
'@
...
class PurchaseListScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Purchases')), body: Center(child: Text('Purchases')));
}
'@
...
class PurchaseFormScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Purchase Form')), body: Center(child: Text('Purchase Form')));
}
'@
...
class CounterOpenScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Open Shift')), body: Center(child: Text('Open Shift')));
}
'@
...
class CounterCloseScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Close Shift')), body: Center(child: Text('Close Shift')));
}
'@
...
class SalesReportScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Sales Report')), body: Center(child: Text('Sales Report')));
}
'@
...
class ProductPerformanceScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Product Performance')), body: Center(child: Text('Product Performance')));
}
'@
...
class AIAnalysisScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('AI Analysis')), body: Center(child: Text('AI Analysis')));
}
'@
...
class SettingsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Settings')), body: Center(child: Text('Settings')));
}
'@
...
class UserListScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Users')), body: Center(child: Text('Users')));
}
'@
...
class UserFormScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('User Form')), body: Center(child: Text('User Form')));
}
'@
...
class ReceivePaymentScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Scaffold(appBar: AppBar(title: Text('Receive Payment')), body: Center(child: Text('Receive Payment')));
}
'@

    # ---------- FIXED BILLING SCREEN (line 301) ----------
                                  ...
                                  try {
                                    ...
                                    if (shouldShare == true) {
                                      ...
                                      for (final item in items) {
                                        // ✅ FIX: Use firstWhere with orElse to return null safely
                                        final cartItem = cartItems.firstWhere(
                                          (ci) => ci.productId == item.productId,
                                          orElse: () => null, // this returns null when not found
                                        );
