# fix_final_purchase.ps1 – Final fix for purchase form
$base = "lib"

$files = @{

    # ---------- CORRECTED PURCHASE ITEM MODEL ----------
...
'@
    ...
    # ---------- CORRECTED PURCHASE FORM (with correct named parameters) ----------
...
class _PurchaseFormScreenState extends ConsumerState<PurchaseFormScreen> {
  ...
  void _addProduct(Product product) {
    // Find existing item without returning null
    int existingIndex = -1;
...
Write-Host "`n✅ Final purchase fixes applied!" -ForegroundColor Cyan
