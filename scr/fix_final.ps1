# fix_final.ps1 – final fixes
$base = "lib"

$files = @{

    # ---------- Create missing CustomerHistoryScreen ----------
...
class CustomerHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Customer History')),
  );
}
'@

    # ---------- Fix all placeholder screens (remove const) ----------
...
class SupplierListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Supplier List')),
  );
}
'@
...
class SupplierFormScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(title: const Text('Supplier Form')),
    body: const Center(child: Text('Supplier Form')),
  );
}
'@
...
class PurchaseListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Purchases')),
  );
}
'@
...
class PurchaseFormScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Purchase Form')),
  );
}
'@
...
class CounterOpenScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Open Shift')),
  );
}
'@
...
class CounterCloseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Close Shift')),
  );
}
'@
...
class SalesReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Sales Report')),
  );
}
'@
...
class ProductPerformanceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Product Performance')),
  );
}
'@
...
class AIAnalysisScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('AI Analysis')),
  );
}
'@
...
class ReceivePaymentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(child: Text('Receive Payment')),
  );
}
'@

    # ---------- Fix billing_screen.dart (nullable CartItem) ----------
                                  ...
                                  try {
                                    ...
                                    if (shouldShare == true) {
                                      ...
                                      for (final item in items) {
                                        // ✅ FIX: declare cartItem as nullable CartItem?
                                        final CartItem? cartItem = cartItems.firstWhere(
