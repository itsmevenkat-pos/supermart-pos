...
migration rule — v26–v32 were already taken.
...
stored, so **upgrading to v33 cannot change what any customer is shown to owe.**

## Files

| File | What |
|---|---|
| `lib/core/database/migrations/migration_v33.dart` | The three tables + six indexes |
